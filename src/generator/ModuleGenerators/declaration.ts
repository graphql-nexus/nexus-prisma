...
export const createModule = (dmmf: DMMF.Document, settings: Gentime.Settings.Manager): Module => {
  return {
    fileName: 'index.d.ts',
    content: dedent`
...
const renderNexusType = (field: DMMF.Field, settings: Gentime.Settings.Manager): string => {
